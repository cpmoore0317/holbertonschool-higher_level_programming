...
class Student:
    ...
    - reload_from_json: Replace all attributes of the Student instance based on a dictionary.
    ...
    def reload_from_json(self, json):
        ...
        :param json: A dictionary with attribute names and their corresponding values.
        """
